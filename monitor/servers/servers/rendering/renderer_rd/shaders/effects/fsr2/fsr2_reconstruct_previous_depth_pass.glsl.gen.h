...
#ifndef FSR2_RECONSTRUCT_PREVIOUS_DEPTH_PASS_GLSL_GEN_H_RD
#define FSR2_RECONSTRUCT_PREVIOUS_DEPTH_PASS_GLSL_GEN_H_RD
...
void main()
{
	ReconstructAndDilate(FFX_MIN16_I2(gl_GlobalInvocationID.xy));
		...
		setup(nullptr, nullptr, _compute_code, "Fsr2ReconstructPreviousDepthPassShaderRD");
	}
};
