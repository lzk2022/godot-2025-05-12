...
#ifndef FSR2_COMPUTE_LUMINANCE_PYRAMID_PASS_GLSL_GEN_H_RD
#define FSR2_COMPUTE_LUMINANCE_PYRAMID_PASS_GLSL_GEN_H_RD
...
void main()
{
    ComputeAutoExposure(gl_WorkGroupID.xyz, gl_LocalInvocationIndex);
		...
		setup(nullptr, nullptr, _compute_code, "Fsr2ComputeLuminancePyramidPassShaderRD");
	}
};
