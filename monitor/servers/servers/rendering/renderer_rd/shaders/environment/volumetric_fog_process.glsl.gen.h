...
#ifndef VOLUMETRIC_FOG_PROCESS_GLSL_GEN_H_RD
#define VOLUMETRIC_FOG_PROCESS_GLSL_GEN_H_RD
...
void main() {
	...
	imageStore(dest_map, pos, imageLoad(source_map, pos));
		...
		setup(nullptr, nullptr, _compute_code, "VolumetricFogProcessShaderRD");
	}
};
